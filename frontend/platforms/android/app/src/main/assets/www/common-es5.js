...
var AuthService = /** @class */ (function () {
    function AuthService(httpClient, storage) {
        ...
        this.AUTH_SERVER_ADDRESS = "https://zerows.azurewebsites.net"; //users/authenticate"
        this.authSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](false);
    }
    AuthService.prototype.register = function (user) {
        var _this = this;
        return this.httpClient.post(this.AUTH_SERVER_ADDRESS + "/register", user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!res.user) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.storage.set("ACCESS_TOKEN", res.user.token)];
                    case 1:
                        _a.sent();
    ...
    AuthService.prototype.login = function (user) {
        var _this = this;
        return this.httpClient.post(this.AUTH_SERVER_ADDRESS + "/users/authenticate", user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!res.user) return [3 /*break*/, 2];
