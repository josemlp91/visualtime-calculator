...
let AuthService = class AuthService {
    ...
    register(user) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/register`, user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.user) {
                yield this.storage.set("ACCESS_TOKEN", res.user.token);
                this.authSubject.next(true);
            }
        })));
    }
    login(user) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/users/authenticate`, user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.user) {
                yield this.storage.set("ACCESS_TOKEN", res.user.token);
                this.authSubject.next(true);
            }
