...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    work_hours = req_body.get('work_hours')
    work_minutes = req_body.get('work_minutes')
    ...
    if work_hours and work_minutes:
        try:
            ...
            return func.HttpResponse(json.dumps(errors), mimetype='application/json', status_code=400)
    ...
    return func.HttpResponse(
            json.dumps(visualtime_client.get_output_time(work_hours, work_minutes)),
